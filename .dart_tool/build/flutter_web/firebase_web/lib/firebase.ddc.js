define(['dart_sdk', 'packages/firebase_web/src/app'], function(dart_sdk, packages__firebase_web__src__app) {
  'use strict';
  ...
  const app = packages__firebase_web__src__app.src__app;
  const auth = packages__firebase_web__src__app.src__auth;
  const database = packages__firebase_web__src__app.src__database;
  const storage = packages__firebase_web__src__app.src__storage;
  const firestore = packages__firebase_web__src__app.src__firestore;
  const functions = packages__firebase_web__src__app.src__functions;
  const utils = packages__firebase_web__src__app.src__utils;
  const js$ = packages__firebase_web__src__app.src__js;
  ...
  dart.setLibraryUri(top_level.FirebaseJsNotLoadedException, "package:firebase_web/src/top_level.dart");
  ...
  top_level.functions = function functions$() {
    let jsObject = dart.global.firebase.functions();
  ...
  dart.setLibraryUri(messaging.Messaging, "package:firebase_web/src/messaging.dart");
  ...
  dart.setLibraryUri(messaging.Notification, "package:firebase_web/src/messaging.dart");
  ...
  dart.setLibraryUri(messaging.Payload, "package:firebase_web/src/messaging.dart");
  dart.trackLibraries("packages/firebase_web/firebase", {
    "package:firebase_web/firebase.dart": firebase,
    "package:firebase_web/src/top_level.dart": top_level,
    "package:firebase_web/src/messaging.dart": messaging
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["src/top_level.dart","src/messaging.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAqIe;;;;;;;AAIQ,YAAA,AAAwC,6CAAR;IAAQ;;;IAH3B;;EAAQ;;;;;;;;;;QAxGhC;QACD;QACA;QACA;QACA;QACA;QACA;AACe,IAAxB,AAAK,IAAD,IAAC,OAAL,qBAAK;AAEL;AACE,YAAW,qBAAY,mCACV,SACG,MAAM,cACF,UAAU,eACT,WAAW,aACb,SAAS,iBACL,aAAa,qBACT,iBAAiB,GACxC,IAAI;;UACD;AACP,oBAAI,6BAAmB,CAAC;AAC2C,QAAjE,WAAM,+CAA6B;;AAG9B,MAAP;;EAEJ;gCAWgB;AACV,mBAAY,AAAK,IAAD,IAAI,OAAQ,yBAAa,IAAI,IAAI;AAErD,UAAW,qBAAY,QAAQ;EACjC;kCAKe;AACT,mBAAY,AAAI,GAAD,IAAI,OAAQ,0BAAc,AAAI,GAAD,aAAa;AAE7D,UAAY,uBAAY,QAAQ;EAClC;0CAQuB;AACjB,mBACC,AAAI,GAAD,IAAI,OAAQ,8BAAkB,AAAI,GAAD,aAAa;AAEtD,UAAgB,+BAAY,QAAQ;EACtC;wCAQqB;AACf,mBACC,AAAI,GAAD,IAAI,OAAQ,6BAAiB,AAAI,GAAD,aAAa;AAErD,UAAe,6BAAY,QAAQ;EACrC;4CAKyB;AACnB,mBACC,AAAI,GAAD,IAAI,OAAQ,+BAAmB,AAAI,GAAD,aAAa;AAEvD,UAAiB,iCAAY,QAAQ;EACvC;;AAGM,mBAAW;AAEf,UAAiB,iCAAY,QAAQ;EACvC;4CAEyB;AACnB,mBACC,AAAI,GAAD,IAAI,OAAQ,+BAAmB,AAAI,GAAD,aAAa;AAEvD,UAAiB,iCAAY,QAAQ;EACvC;6DAWwB;AACtB,QAAU,0BAAN,KAAK;AACP,YAAO;;AAGT,kBAAI,oBAAe,KAAK,EAAE;AACpB,oBAAU,oBAAe,KAAK,EAAE;AACpC,YAAe,