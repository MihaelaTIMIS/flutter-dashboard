define(['dart_sdk'], function(dart_sdk) {
  ...
  let ExpandoOfHttpsCallableOptions = () => (ExpandoOfHttpsCallableOptions = dart.constFn(core.Expando$(functions.HttpsCallableOptions)))();
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(database.DatabaseReference.getInstance, ReferenceJsImplToDatabaseReferenceOfReferenceJsImpl());
    },
    get C1() {
    ...
    get C14() {
      return C14 = dart.fn(functions.HttpsCallableResult.getInstance, HttpsCallableResultJsImplToHttpsCallableResult());
    },
    get C15() {
      return C15 = dart.fn(auth$.User.getInstance, UserJsImplToUser());
    }
  });
  ...
  js$.JsObjectWrapper$ = dart.generic(T => {
    ...
    dart.setLibraryUri(JsObjectWrapper, "package:firebase_web/src/js.dart");
  ...
  dart.setLibraryUri(database.Database, "package:firebase_web/src/database.dart");
  ...
  database.Query$ = dart.generic(T => {
    ...
    dart.setLibraryUri(Query, "package:firebase_web/src/database.dart");
  ...
  database.DatabaseReference$ = dart.generic(T => {
    class DatabaseReference extends database.Query$(T) {
      ...
      static getInstance(jsObject) {
        ...
        t1 = jsObject;
        t2 = t0._get(t1);
        return t2 == null ? (t3 = new (DatabaseReferenceOfReferenceJsImpl())._fromJsObject(jsObject), t0._set(t1, t3), t3) : t2;
      }
      child(path) {
    ...
    dart.setLibraryUri(DatabaseReference, "package:firebase_web/src/database.dart");
  ...
  dart.setLibraryUri(database.QueryEvent, "package:firebase_web/src/database.dart");
  ...
  dart.setLibraryUri(database.DataSnapshot, "package:firebase_web/src/database.dart");
  ...
  dart.setLibraryUri(database.OnDisconnect, "package:firebase_web/src/database.dart");
  ...
  database.ThenableReference = class ThenableReference extends database.DatabaseReference$(dart.lazyJSType(() => dart.global.firebase.database.ThenableReference, "firebase.database.ThenableReference")) {
    get future() {
      let t0;
      t0 = this[_future];
      return t0 == null ? this[_future] = utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.database.Reference, "firebase.database.Reference"), this.jsObject).then(DatabaseReferenceOfReferenceJsImpl(), C0 || CT.C0) : t0;
    }
  };
  ...
  dart.setLibraryUri(database.ThenableReference, "package:firebase_web/src/database.dart");
  ...
  dart.setLibraryUri(database.Transaction, "package:firebase_web/src/database.dart");
  ...
  dart.setLibraryUri(firestore.Firestore, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._Updatable, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.WriteBatch, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.DocumentReference, "package:firebase_web/src/firestore.dart");
  ...
  firestore.Query$ = dart.generic(T => {
    ...
    dart.setLibraryUri(Query, "package:firebase_web/src/firestore.dart");
    dart.setFieldSignature(Query, () => ({
      __proto__: dart.getFields(Query.__proto__),
  ...
  firestore.CollectionReference$ = dart.generic(T => {
    ...
    dart.setLibraryUri(CollectionReference, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.DocumentChange, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.DocumentSnapshot, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.QuerySnapshot, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.Transaction, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._FieldValueDelete, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._FieldValueServerTimestamp, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._FieldValueArray, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._FieldValueArrayUnion, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore._FieldValueArrayRemove, "package:firebase_web/src/firestore.dart");
  ...
  dart.setLibraryUri(firestore.FieldValue, "package:firebase_web/src/firestore.dart");
  ...
  dart.setMethodSignature(app.App, () => ({
    ...
    functions: dart.fnType(functions.Functions, [])
  }));
  ...
  dart.setLibraryUri(app.App, "package:firebase_web/src/app.dart");
  ...
  dart.setLibraryUri(storage.TaskState, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.Storage, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.StorageReference, "package:firebase_web/src/storage.dart");
  ...
  storage._SettableMetadataBase$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_SettableMetadataBase, "package:firebase_web/src/storage.dart");
  ...
  storage._UploadMetadataBase$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_UploadMetadataBase, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.FullMetadata, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.UploadMetadata, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.UploadTask, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.UploadTaskSnapshot, "package:firebase_web/src/storage.dart");
  ...
  dart.setLibraryUri(storage.SettableMetadata, "package:firebase_web/src/storage.dart");
  functions.Functions = class Functions extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.functions.Functions, "firebase.functions.Functions")) {
    ...
    httpsCallable(name, options = null) {
      ...
      if (options != null) {
        httpCallableImpl = this.jsObject.httpsCallable(name, options.jsObject);
      } else {
  ...
  dart.setMethodSignature(functions.Functions, () => ({
    ...
    httpsCallable: dart.fnType(functions.HttpsCallable, [core.String], [functions.HttpsCallableOptions]),
  ...
  dart.setLibraryUri(functions.Functions, "package:firebase_web/src/functions.dart");
  ...
  functions.HttpsCallable = class HttpsCallable extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.functions.HttpsCallable, "firebase.functions.HttpsCallable")) {
    ...
    call(data) {
      return utils.handleThenable(dart.anonymousJSType("HttpsCallableResultJsImpl"), this.jsObject(utils.jsify(data))).then(functions.HttpsCallableResult, C14 || CT.C14);
    }
  };
  ...
  dart.setLibraryUri(functions.HttpsCallable, "package:firebase_web/src/functions.dart");
  ...
  functions.HttpsCallableOptions = class HttpsCallableOptions extends js$.JsObjectWrapper$(dart.anonymousJSType("HttpsCallableOptionsJsImpl")) {
    static new(opts) {
      let timeout = opts && 'timeout' in opts ? opts.timeout : null;
      return new functions.HttpsCallableOptions._fromJsObject({timeout: timeout});
    }
    static getInstance(jsObject) {
      let t5, t4, t3, t2;
      if (jsObject == null) {
      ...
      t2 = functions.HttpsCallableOptions._expando;
      t3 = jsObject;
      t4 = t2._get(t3);
      return t4 == null ? (t5 = new functions.HttpsCallableOptions._fromJsObject(jsObject), t2._set(t3, t5), t5) : t4;
    }
    get timeout() {
      return this.jsObject.timeout;
    }
    set(timeout) {
      return this.jsObject.timeout = timeout;
    }
  };
  (functions.HttpsCallableOptions._fromJsObject = function(jsObject) {
    functions.HttpsCallableOptions.__proto__.fromJsObject.call(this, jsObject);
    ;
  }).prototype = functions.HttpsCallableOptions.prototype;
  dart.addTypeTests(functions.HttpsCallableOptions);
  dart.setMethodSignature(functions.HttpsCallableOptions, () => ({
    __proto__: dart.getMethods(functions.HttpsCallableOptions.__proto__),
    set: dart.fnType(dart.dynamic, [core.int])
  }));
  dart.setGetterSignature(functions.HttpsCallableOptions, () => ({
    __proto__: dart.getGetters(functions.HttpsCallableOptions.__proto__),
    timeout: core.int
  }));
  dart.setLibraryUri(functions.HttpsCallableOptions, "package:firebase_web/src/functions.dart");
  dart.defineLazy(functions.HttpsCallableOptions, {
    /*functions.HttpsCallableOptions._expando*/get _expando() {
      return new (ExpandoOfHttpsCallableOptions()).new();
    }
  });
  ...
  dart.setLibraryUri(functions.HttpsCallableResult, "package:firebase_web/src/functions.dart");
  ...
  auth$.UserInfo$ = dart.generic(T => {
    ...
    dart.setLibraryUri(UserInfo, "package:firebase_web/src/auth.dart");
    return UserInfo;
  });
  ...
  auth$.User = class User extends auth$.UserInfo$(dart.anonymousJSType("UserJsImpl")) {
    ...
    linkWithCredential(credential) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.linkWithCredential(credential)).then(auth$.User, C15 || CT.C15);
    }
    ...
    unlink(providerId) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.unlink(providerId)).then(auth$.User, C15 || CT.C15);
    }
  ...
  dart.setLibraryUri(auth$.User, "package:firebase_web/src/auth.dart");
  ...
  auth$.Auth = class Auth extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.auth.Auth, "firebase.auth.Auth")) {
    ...
    get onAuthStateChanged() {
      if (this[_changeController$] == null) {
        ...
        let errorWrapper = js.allowInterop(dynamicTovoid(), dart.fn(e => this[_changeController$].addError(e), dynamicTovoid()));
        const startListen = () => {
          if (!(this[_onAuthUnsubscribe] == null)) dart.assertFailed(null, "org-dartlang-app:///packages/firebase_web/src/auth.dart", 281, 16, "_onAuthUnsubscribe == null");
    ...
    get onIdTokenChanged() {
      if (this[_idTokenChangedController] == null) {
        ...
        const startListen = () => {
          if (!(this[_onIdTokenChangedUnsubscribe] == null)) dart.assertFailed(null, "org-dartlang-app:///packages/firebase_web/src/auth.dart", 316, 16, "_onIdTokenChangedUnsubscribe == null");
    ...
    signInWithCredential(credential) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.signInWithCredential(credential)).then(auth$.User, C15 || CT.C15);
    }
  ...
  dart.setLibraryUri(auth$.Auth, "package:firebase_web/src/auth.dart");
  ...
  auth$.AuthProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(AuthProvider, "package:firebase_web/src/auth.dart");
    return AuthProvider;
  });
  ...
  dart.setLibraryUri(auth$.EmailAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.FacebookAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.GithubAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.GoogleAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.TwitterAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.PhoneAuthProvider, "package:firebase_web/src/auth.dart");
  ...
  auth$.ApplicationVerifier$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ApplicationVerifier, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.RecaptchaVerifier, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.ConfirmationResult, "package:firebase_web/src/auth.dart");
  ...
  dart.setLibraryUri(auth$.UserCredential, "package:firebase_web/src/auth.dart");
