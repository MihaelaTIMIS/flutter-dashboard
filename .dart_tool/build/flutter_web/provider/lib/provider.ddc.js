define(['dart_sdk', 'packages/flutter/src/widgets/actions', 'packages/flutter/src/foundation/_bitfield_web'], function(dart_sdk, packages__flutter__src__widgets__actions, packages__flutter__src__foundation___bitfield_web) {
  ...
  dart.defineLazy(CT, {
    ...
    get C53() {
      return C53 = dart.constList([C54 || CT.C54, C55 || CT.C55, C8 || CT.C8, C9 || CT.C9], widget_inspector._Location);
    },
    get C52() {
    ...
    get C102() {
      return C102 = dart.fn(change_notifier_provider.ChangeNotifierProvider._disposer, BuildContextAndChangeNotifierTovoid());
    },
    get C105() {
    ...
    get C122() {
      return C122 = dart.constList([C123 || CT.C123, C124 || CT.C124, C125 || CT.C125, C126 || CT.C126, C127 || CT.C127, C128 || CT.C128], widget_inspector._Location);
    },
    get C121() {
  ...
  let C6;
  let C5;
  const delegate$ = dart.privateName(delegate_widget, "DelegateWidget.delegate");
  ...
  const child$ = dart.privateName(listenable_provider, "ListenableProvider.child");
  listenable_provider.ListenableProvider$ = dart.generic(T => {
    ...
    (ListenableProvider.new = function(opts) {
      ...
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProvider.__.call(this, {key: key, delegate: new (_BuilderListenableDelegateOfT()).new((t0 = create, t0 == null ? builder : t0), {dispose: dispose}), child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
  ...
  const value$ = dart.privateName(delegate_widget, "SingleValueDelegate.value");
  ...
  listenable_provider._ValueListenableDelegate$ = dart.generic(T => {
    ...
    class _ValueListenableDelegate extends SingleValueDelegate__ListenableDelegateMixin$36 {
      ...
      startListening(listenable, opts) {
        T._check(listenable);
        let rebuild = opts && 'rebuild' in opts ? opts.rebuild : false;
        if (!(this.disposer == null || dart.test(this.debugCheckIsNewlyCreatedListenable(listenable)))) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/listenable_provider.dart", 116, 12, "disposer == null || debugCheckIsNewlyCreatedListenable(listenable)");
        super.startListening(listenable, {rebuild: rebuild});
      }
    }
    (_ValueListenableDelegate.new = function(value, disposer = null) {
  ...
  listenable_provider._BuilderListenableDelegate$ = dart.generic(T => {
    ...
    class _BuilderListenableDelegate extends BuilderStateDelegate__ListenableDelegateMixin$36 {
      startListening(listenable, opts) {
        T._check(listenable);
        let rebuild = opts && 'rebuild' in opts ? opts.rebuild : false;
        if (!dart.test(this.debugCheckIsNewlyCreatedListenable(listenable))) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/listenable_provider.dart", 128, 12, "debugCheckIsNewlyCreatedListenable(listenable)");
        super.startListening(listenable, {rebuild: rebuild});
      }
    }
    (_BuilderListenableDelegate.new = function(create, opts) {
      let dispose = opts && 'dispose' in opts ? opts.dispose : null;
      _BuilderListenableDelegate.__proto__.new.call(this, create, {dispose: dispose});
      ;
  ...
  const initialBuilder$ = dart.privateName(proxy_provider, "ProxyProviderBase.initialBuilder");
  const dispose$ = dart.privateName(proxy_provider, "ProxyProviderBase.dispose");
  proxy_provider.ProxyProviderBase$ = dart.generic(R => {
    ...
    (ProxyProviderBase.new = function(opts) {
      ...
      this[initialBuilder$] = (t0 = create, t0 == null ? initialBuilder : t0);
  ...
  const child$0 = dart.privateName(listenable_provider, "_NumericProxyProvider.child");
  const builder$ = dart.privateName(listenable_provider, "_NumericProxyProvider.builder");
  listenable_provider._NumericProxyProvider$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    (_NumericProxyProvider.new = function(opts) {
      ...
      this[child$0] = child;
      if (!(builder != null)) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/listenable_provider.dart", 225, 16, "builder != null");
      _NumericProxyProvider.__proto__.new.call(this, {key: key, create: initialBuilder, dispose: dispose, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider$ = dart.generic((T, R) => {
    ...
    (ListenableProxyProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    (ListenableProxyProvider2.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider2.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    (ListenableProxyProvider3.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider3.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    (ListenableProxyProvider4.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider4.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    (ListenableProxyProvider5.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider5.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  listenable_provider.ListenableProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    (ListenableProxyProvider6.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ListenableProxyProvider6.__proto__.new.call(this, {key: key, initialBuilder: (t0 = create, t0 == null ? initialBuilder : t0), builder: (t0$ = update, t0$ == null ? builder : t0$), dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  const child$1 = dart.privateName(proxy_provider, "NumericProxyProvider.child");
  const builder$0 = dart.privateName(proxy_provider, "NumericProxyProvider.builder");
  const updateShouldNotify$ = dart.privateName(proxy_provider, "NumericProxyProvider.updateShouldNotify");
  proxy_provider.NumericProxyProvider$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    class NumericProxyProvider extends proxy_provider.ProxyProviderBase$(R) {
      ...
      cloneWithChild(child) {
        return new (NumericProxyProviderOfT$T2$T3$T4$T5$T6$R()).new({key: this.key, create: this.initialBuilder, update: this.builder, updateShouldNotify: this.updateShouldNotify, dispose: this.dispose, child: child, $creationLocationd_0dea112b090073317d4: C22 || CT.C22});
      }
      build(context, value) {
        R._check(value);
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/proxy_provider.dart", 244, 12, "() {\n      Provider.debugCheckInvalidValueType?.call(value);\n      return true;\n    }()");
    ...
    (NumericProxyProvider.new = function(opts) {
      ...
      this[child$1] = child;
      if (!(builder != null || update != null)) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/proxy_provider.dart", 199, 16, "builder != null || update != null");
      this[builder$0] = (t0 = update, t0 == null ? builder : t0);
      NumericProxyProvider.__proto__.new.call(this, {key: key, create: (t0$ = create, t0$ == null ? initialBuilder : t0$), dispose: dispose, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider$ = dart.generic((T, R) => {
    ...
    (ProxyProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    (ProxyProvider2.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider2.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    (ProxyProvider3.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider3.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    (ProxyProvider4.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider4.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    (ProxyProvider5.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider5.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  proxy_provider.ProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    (ProxyProvider6.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ProxyProvider6.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), updateShouldNotify: updateShouldNotify, dispose: dispose, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  const _value$1 = dart.privateName(provider$, "InheritedProvider._value");
  const _updateShouldNotify$ = dart.privateName(provider$, "InheritedProvider._updateShouldNotify");
  ...
  let C36;
  let C35;
  const providers$ = dart.privateName(provider$, "MultiProvider.providers");
  const child$2 = dart.privateName(provider$, "MultiProvider.child");
  ...
  const updateShouldNotify$0 = dart.privateName(provider$, "Provider.updateShouldNotify");
  const child$3 = dart.privateName(provider$, "Provider.child");
  provider$.Provider$ = dart.generic(T => {
    ...
    class Provider extends delegate_widget.ValueDelegateWidget$(T) {
      get updateShouldNotify() {
        return this[updateShouldNotify$0];
      }
      set updateShouldNotify(value) {
        super.updateShouldNotify = value;
      }
      ...
      build(context) {
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/provider.dart", 340, 12, "() {\n      Provider.debugCheckInvalidValueType?.call<T>(delegate.value);\n      return true;\n    }()");
    ...
    (Provider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      Provider.__.call(this, {key: key, delegate: new (BuilderStateDelegateOfT()).new((t0 = create, t0 == null ? builder : t0), {dispose: dispose}), updateShouldNotify: null, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ...
    (Provider.__ = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      this[updateShouldNotify$0] = updateShouldNotify;
      this[child$3] = child;
  ...
  const child$4 = dart.privateName(value_listenable_provider, "ValueListenableProvider.child");
  const updateShouldNotify$1 = dart.privateName(value_listenable_provider, "ValueListenableProvider.updateShouldNotify");
  value_listenable_provider.ValueListenableProvider$ = dart.generic(T => {
    ...
    class ValueListenableProvider extends delegate_widget.ValueDelegateWidget$(change_notifier.ValueListenable$(T)) {
      ...
      get updateShouldNotify() {
        return this[updateShouldNotify$1];
      }
      set updateShouldNotify(value) {
        super.updateShouldNotify = value;
      }
    ...
    (ValueListenableProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ValueListenableProvider.__.call(this, {key: key, delegate: new (BuilderStateDelegateOfValueNotifierOfT()).new((t0 = create, t0 == null ? builder : t0), {dispose: C51 || CT.C51}), updateShouldNotify: updateShouldNotify, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ...
    (ValueListenableProvider.__ = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      this[updateShouldNotify$1] = updateShouldNotify;
      this[child$4] = child;
  ...
  const builder$1 = dart.privateName(selector, "Selector0.builder");
  const selector$ = dart.privateName(selector, "Selector0.selector");
  const child$5 = dart.privateName(selector, "Selector0.child");
  selector.Selector0$ = dart.generic(T => {
    ...
    class Selector0 extends framework.StatefulWidget {
      ...
      cloneWithChild(child) {
        return new (Selector0OfT()).new({key: this.key, selector: this.selector, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C66 || CT.C66});
      }
    }
  ...
  const value$0 = dart.privateName(selector, "_Selector0State.value");
  ...
  const child$6 = dart.privateName(consumer, "Consumer.child");
  const builder$2 = dart.privateName(consumer, "Consumer.builder");
  consumer.Consumer$ = dart.generic(T => {
    ...
    class Consumer extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (ConsumerOfT()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C72 || CT.C72});
      }
    }
  ...
  const child$7 = dart.privateName(consumer, "Consumer2.child");
  const builder$3 = dart.privateName(consumer, "Consumer2.builder");
  consumer.Consumer2$ = dart.generic((A, B) => {
    ...
    class Consumer2 extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (Consumer2OfA$B()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C77 || CT.C77});
      }
    }
  ...
  const child$8 = dart.privateName(consumer, "Consumer3.child");
  const builder$4 = dart.privateName(consumer, "Consumer3.builder");
  consumer.Consumer3$ = dart.generic((A, B, C) => {
    ...
    class Consumer3 extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (Consumer3OfA$B$C()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C82 || CT.C82});
      }
    }
  ...
  const child$9 = dart.privateName(consumer, "Consumer4.child");
  const builder$5 = dart.privateName(consumer, "Consumer4.builder");
  consumer.Consumer4$ = dart.generic((A, B, C, D) => {
    ...
    class Consumer4 extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (Consumer4OfA$B$C$D()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C87 || CT.C87});
      }
    }
  ...
  const child$10 = dart.privateName(consumer, "Consumer5.child");
  const builder$6 = dart.privateName(consumer, "Consumer5.builder");
  consumer.Consumer5$ = dart.generic((A, B, C, D, E) => {
    ...
    class Consumer5 extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (Consumer5OfA$B$C$D$E()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C92 || CT.C92});
      }
    }
  ...
  const child$11 = dart.privateName(consumer, "Consumer6.child");
  const builder$7 = dart.privateName(consumer, "Consumer6.builder");
  consumer.Consumer6$ = dart.generic((A, B, C, D, E, F) => {
    ...
    class Consumer6 extends framework.StatelessWidget {
      ...
      cloneWithChild(child) {
        return new (Consumer6OfA$B$C$D$E$F()).new({key: this.key, builder: this.builder, child: child, $creationLocationd_0dea112b090073317d4: C97 || CT.C97});
      }
    }
  ...
  change_notifier_provider.ChangeNotifierProvider$ = dart.generic(T => {
    ...
    (ChangeNotifierProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProvider.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? builder : t0), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider$ = dart.generic((T, R) => {
    ...
    (ChangeNotifierProxyProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    (ChangeNotifierProxyProvider2.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider2.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    (ChangeNotifierProxyProvider3.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider3.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    (ChangeNotifierProxyProvider4.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider4.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    (ChangeNotifierProxyProvider5.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider5.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  change_notifier_provider.ChangeNotifierProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    (ChangeNotifierProxyProvider6.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      ChangeNotifierProxyProvider6.__proto__.new.call(this, {key: key, create: (t0 = create, t0 == null ? initialBuilder : t0), update: (t0$ = update, t0$ == null ? builder : t0$), dispose: C102 || CT.C102, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
      ;
  ...
  const initialData$ = dart.privateName(async_provider, "StreamProvider.initialData");
  const child$12 = dart.privateName(async_provider, "StreamProvider.child");
  const catchError$ = dart.privateName(async_provider, "StreamProvider.catchError");
  const updateShouldNotify$2 = dart.privateName(async_provider, "StreamProvider.updateShouldNotify");
  async_provider.StreamProvider$ = dart.generic(T => {
    ...
    class StreamProvider extends delegate_widget.ValueDelegateWidget$(async.Stream$(T)) {
      ...
      get updateShouldNotify() {
        return this[updateShouldNotify$2];
      }
      set updateShouldNotify(value) {
        super.updateShouldNotify = value;
      }
      cloneWithChild(child) {
        return new (StreamProviderOfT()).__({key: this.key, delegate: this.delegate, updateShouldNotify: this.updateShouldNotify, initialData: this.initialData, catchError: this.catchError, child: child, $creationLocationd_0dea112b090073317d4: C103 || CT.C103});
      }
      build(context) {
        return new (StreamBuilderOfT()).new({stream: this.delegate.value, initialData: this.initialData, builder: dart.fn((_, snapshot) => new (InheritedProviderOfT()).new({value: async_provider._snapshotToValue(T, snapshot, context, this.catchError, this), child: this.child, updateShouldNotify: this.updateShouldNotify, $creationLocationd_0dea112b090073317d4: C111 || CT.C111}), BuildContextAndAsyncSnapshotOfTToInheritedProviderOfT()), $creationLocationd_0dea112b090073317d4: C116 || CT.C116});
      }
    }
    (StreamProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      StreamProvider.__.call(this, {key: key, delegate: new (BuilderStateDelegateOfStreamOfT()).new((t0 = create, t0 == null ? builder : t0)), initialData: initialData, catchError: catchError, updateShouldNotify: updateShouldNotify, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ...
    (StreamProvider.controller = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      StreamProvider.__.call(this, {key: key, delegate: new (_StreamControllerBuilderDelegateOfT()).new((t0 = create, t0 == null ? builder : t0)), initialData: initialData, catchError: catchError, updateShouldNotify: updateShouldNotify, child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    }).prototype = StreamProvider.prototype;
    ...
    (StreamProvider.__ = function(opts) {
      ...
      this[updateShouldNotify$2] = updateShouldNotify;
      this[child$12] = child;
  ...
  const _create$ = dart.privateName(async_provider, "_create");
  const _is__StreamControllerBuilderDelegate_default = Symbol('_is__StreamControllerBuilderDelegate_default');
  const value$1 = dart.privateName(async_provider, "_StreamControllerBuilderDelegate.value");
  async_provider._StreamControllerBuilderDelegate$ = dart.generic(T => {
    ...
    class _StreamControllerBuilderDelegate extends delegate_widget.ValueStateDelegate$(async.Stream$(T)) {
      ...
      set value(value) {
        this[value$1] = StreamOfT()._check(value);
      }
      initDelegate() {
        let t0;
        super.initDelegate();
        this[_controller] = this[_create$](this.context);
    ...
    (_StreamControllerBuilderDelegate.new = function(_create) {
      this[_controller] = null;
      this[value$1] = null;
      this[_create$] = _create;
      if (!(_create != null)) dart.assertFailed(null, "org-dartlang-app:///packages/provider/src/async_provider.dart", 185, 59, "_create != null");
    ...
    dart.setFieldSignature(_StreamControllerBuilderDelegate, () => ({
      ...
      [_create$]: dart.finalFieldType(dart.fnType(async.StreamController$(T), [framework.BuildContext])),
  ...
  const initialData$0 = dart.privateName(async_provider, "FutureProvider.initialData");
  const child$13 = dart.privateName(async_provider, "FutureProvider.child");
  const catchError$0 = dart.privateName(async_provider, "FutureProvider.catchError");
  const updateShouldNotify$3 = dart.privateName(async_provider, "FutureProvider.updateShouldNotify");
  async_provider.FutureProvider$ = dart.generic(T => {
    ...
    class FutureProvider extends delegate_widget.ValueDelegateWidget$(async.Future$(T)) {
      ...
      get catchError() {
        return this[catchError$0];
      }
      set catchError(value) {
        super.catchError = value;
      }
      get updateShouldNotify() {
        return this[updateShouldNotify$3];
      }
      set updateShouldNotify(value) {
        super.updateShouldNotify = value;
      }
      cloneWithChild(child) {
        return new (FutureProviderOfT()).__({key: this.key, delegate: this.delegate, updateShouldNotify: this.updateShouldNotify, initialData: this.initialData, catchError: this.catchError, child: child, $creationLocationd_0dea112b090073317d4: C121 || CT.C121});
      }
      build(context) {
        return new (FutureBuilderOfT()).new({future: this.delegate.value, initialData: this.initialData, builder: dart.fn((_, snapshot) => new (InheritedProviderOfT()).new({value: async_provider._snapshotToValue(T, snapshot, context, this.catchError, this), updateShouldNotify: this.updateShouldNotify, child: this.child, $creationLocationd_0dea112b090073317d4: C129 || CT.C129}), BuildContextAndAsyncSnapshotOfTToInheritedProviderOfT()), $creationLocationd_0dea112b090073317d4: C134 || CT.C134});
      }
    }
    (FutureProvider.new = function(opts) {
      ...
      let child = opts && 'child' in opts ? opts.child : null;
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      FutureProvider.__.call(this, {key: key, initialData: initialData, catchError: catchError, updateShouldNotify: updateShouldNotify, delegate: new (BuilderStateDelegateOfFutureOfT()).new((t0 = create, t0 == null ? builder : t0)), child: child, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ...
    (FutureProvider.__ = function(opts) {
      ...
      this[catchError$0] = catchError;
      this[updateShouldNotify$3] = updateShouldNotify;
      this[child$13] = child;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["src/delegate_widget.dart","src/listenable_provider.dart","src/proxy_provider.dart","src/provider.dart","src/value_listenable_provider.dart","src/selector.dart","src/consumer.dart","src/change_notifier_provider.dart","src/async_provider.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAuFsB;;;;;;;AAWe,sDAAiB;IAAK;;AAGnB;IAAsB;;;QAvBtD;QACC;;;UACM,AAAS,QAAD,IAAI;AACnB,kEAAW,GAAG;;EAAC;;;;;;;;;;;;;;;;AAwMiB,cAAe,4BAAT;MAAiC;;;UANvE;UAC4B;;AAC7B,yDAAW,GAAG,YAAY,QAAQ;;IAAC;;;;;;;;;;;;;;;;;;;;;;MC1M3B;;;;;;qBAG+B;AAC1C,cAA0B,wCACnB,oBACc,iCAAT,uBACH,KAAK;MAEhB;YAG0B;AAClB,uBAAyB,iCAAT;AACtB,cAAO,0CACE,AAAS,QAAD,iDACK,AAAS,QAAD,6BACrB;MAEX;;;;UAnEM;UACsB;UAEN;UACR;UACL;;6CAEI,GAAG,YAGJ,2CAAkC,KAAP,MAAM,QAAN,OAAU,OAAO,kBAAW,OAAO,WAC3D,KAAK;IACb;;UAID;UACQ;UACL;;6CAEI,GAAG,YACE,wCAAyB,KAAK,UACjC,KAAK;IACb;;UAGD;UACQ;UACA;UACL;;6CAEI,GAAG,YACE,wCAAyB,KAAK,EAAE,QAAQ,UAC3C,KAAK;IACb;;UAGD;UACkC;UAGjC;;;AACF,wDAAW,GAAG,YAAY,QAAQ;;IAAC;;;;;;;;;;;;;;;;;;;;;;;ADxCZ;IAAQ;;AAQR;IAAS;;IAMh